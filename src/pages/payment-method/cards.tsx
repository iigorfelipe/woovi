...
export const Cards = ({ parcelas, handleChecked }: CardProps) => {
  ...
  return (
    <Box className="rounded-[10px] flex flex-col w-full mt-4">
      {
        parcelas.map((parcela, index) => (
          ...
          >
            {
              index === 0 && (
                <Box className="w-[67px] h-[27px] border-2 bg-[#E5E5E5] rounded-[100px] flex items-center justify-center mt-[-30px]">
            ...
            {
              index === 1 && (
                <Box className="w-[157px] h-[27px] border-2 bg-[#E5E5E5] rounded-[100px] flex items-center justify-center mt-[-30px]">
            ...
            </Box>
            {
              parcela.cashBack?.desconto ? (
                <>
                  ...
                  <Box className="bg-[#133A6F] flex items-center p-2 rounded-md">
